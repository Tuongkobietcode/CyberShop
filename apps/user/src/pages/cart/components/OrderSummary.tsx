...
export const OrderSummary: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-md bg-white p-10 border border-gray-200 rounded">
      ...
      <div className="mb-5">
        ...
        <input
          type="text"
          placeholder="Code"
          className="w-full border border-gray-300 rounded p-4 text-sm focus:outline-none"
        />
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2 border border-gray-300 rounded">
          ...
          />
          <button className="px-4 border rounded text-xs h-8 my-auto mr-4">Apply</button>
        </div>
      </div>

      <div className="space-y-3 text-sm mb-6">
        <div className="flex justify-between">
          <span className="text-gray-600 font-semibold mb-2">Subtotal</span>
