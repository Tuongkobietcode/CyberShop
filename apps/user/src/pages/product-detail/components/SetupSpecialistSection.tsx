  ...
  return (
    <section className="rounded-[36px] border border-black/6 bg-[linear-gradient(180deg,#f6f7fb_0%,#f2f3f8_100%)] px-6 py-14 text-center shadow-[0_18px_42px_rgba(15,23,42,0.05)] sm:px-10 sm:py-16">
      <div className="mx-auto max-w-[860px]">
        <h2 className="mx-auto max-w-[12ch] text-[2.3rem] font-semibold leading-[0.98] tracking-[-0.06em] text-[var(--text-primary)] sm:text-[3.1rem]">
          Set up your device with one-on-one sessions and guided support.
        </h2>

        <div className="mt-8 flex flex-wrap items-center justify-center gap-5 text-[var(--accent)]">
        ...
        <p className="mx-auto mt-8 max-w-[42ch] text-[15px] leading-8 text-[var(--text-secondary)] sm:text-lg">
        ...
        <button
          type="button"
          className="mt-8 inline-flex items-center gap-2 text-base font-medium text-[var(--accent)] transition hover:text-[var(--accent-strong)]"
        >
