      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        {services.map((service) => (
          ...
          >
            ...
            <h3 className="mt-5 text-[1.2rem] font-semibold tracking-[-0.04em] text-[var(--text-primary)]">
              {service.title}
            </h3>
            <p className="mt-3 text-sm leading-7 text-[var(--text-secondary)]">{service.copy}</p>
          </article>
        ))}
      </div>
    </section>
