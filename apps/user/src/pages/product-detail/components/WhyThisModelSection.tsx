  ...
  return (
    <section className="space-y-8">
      <div className="max-w-[740px]">
        ...
        <h2 className="mt-3 text-[2.2rem] font-semibold leading-[0.96] tracking-[-0.06em] text-[var(--text-primary)] sm:text-[2.8rem]">
      ...
      <div className="grid gap-5 md:grid-cols-3">
        {reasons.map((reason) => (
          ...
          >
            <h3 className="text-[1.2rem] font-semibold tracking-[-0.04em] text-[var(--text-primary)]">
              {reason.title}
            </h3>
            <p className="mt-3 text-sm leading-7 text-[var(--text-secondary)]">{reason.copy}</p>
          </article>
        ))}
      </div>
    </section>
