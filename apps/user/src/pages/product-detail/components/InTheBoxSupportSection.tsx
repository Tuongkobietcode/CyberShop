    ...
    <section className="grid gap-6 lg:grid-cols-[0.88fr_1.12fr]">
      <article className="rounded-[32px] border border-black/6 bg-white/82 p-7 shadow-[0_18px_42px_rgba(15,23,42,0.05)]">
        <div className="flex items-center gap-3">
          <div className="rounded-2xl border border-[rgba(14,165,233,0.16)] bg-[rgba(14,165,233,0.08)] p-3 text-[var(--accent)]">
            <Box className="h-5 w-5" />
          </div>
          <div>
            <p className="cy-kicker">In the box</p>
            <h2 className="mt-1 text-[1.6rem] font-semibold tracking-[-0.05em] text-[var(--text-primary)]">
      ...
      <article className="rounded-[32px] border border-black/6 bg-[linear-gradient(180deg,#ffffff_0%,#f6f8fb_100%)] p-7 shadow-[0_18px_42px_rgba(15,23,42,0.05)]">
        ...
        <h2 className="mt-3 max-w-[12ch] text-[2rem] font-semibold leading-[0.96] tracking-[-0.06em] text-[var(--text-primary)]">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          {supportItems.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="rounded-2xl border border-[rgba(14,165,233,0.14)] bg-[rgba(14,165,233,0.07)] p-3 text-[var(--accent)] w-fit">
