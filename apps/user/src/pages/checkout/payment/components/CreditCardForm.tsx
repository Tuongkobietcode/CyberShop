  ...
  return (
    <div className="space-y-5">
      <div className="max-w-[360px] rounded-[24px] bg-black p-8 text-white shadow-[0_24px_60px_rgba(0,0,0,0.18)]">
        ...
        <p className="mt-16 text-[2rem] tracking-[0.18em]">
          4085 9536 8475 9530
        </p>
      ...
      <input
        className="h-16 w-full rounded-2xl border border-black/10 bg-white px-5 text-base outline-none"
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <input
          className="h-16 rounded-2xl border border-black/10 bg-white px-5 text-base outline-none"
