...
export default function Footer() {
  return (
    <footer className="border-t border-black/6 bg-[rgba(248,248,250,0.92)] text-[var(--text-primary)] backdrop-blur-xl">
      <div className="cy-shell grid gap-12 py-16 lg:grid-cols-[1.45fr_0.85fr_0.85fr_0.85fr] lg:py-24">
        <div>
          <Link
            to="/home"
            className="text-[2rem] font-bold tracking-[-0.07em] text-[var(--text-primary)]"
          >
            CyberShop
          </Link>
          <p className="mt-6 max-w-sm text-[15px] leading-8 text-[var(--text-secondary)]">
          ...
          <div className="mt-10 flex items-center gap-6 text-[var(--text-secondary)]">
