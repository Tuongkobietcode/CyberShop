...
export function AdminModalShell({
  ...
  return (
    <div className="admin-modal-overlay fixed inset-0 z-50 flex items-center justify-center bg-black/35 p-4 backdrop-blur-sm">
      <div
        className={`admin-modal-panel w-full ${widthClass} overflow-hidden rounded-[32px] border border-black/10 bg-white shadow-[0_28px_100px_rgba(15,23,42,0.24)]`}
      >
