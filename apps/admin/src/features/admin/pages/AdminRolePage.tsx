      ...
      <div className="grid gap-6 xl:grid-cols-[0.78fr_1.22fr]">
        <div className="space-y-6">
          <section className={surface}>
            <div className="flex flex-col items-center text-center">
              <div className="flex h-28 w-28 items-center justify-center rounded-full bg-black text-4xl font-semibold text-white">
                A
              </div>
              <h2 className="mt-6 text-[2rem] font-semibold tracking-[-0.05em] text-black">
                System Admin
              </h2>
          ...
          <section className={surface}>
            ...
            <div className="mt-6 space-y-4">
              ...
              <button
                type="button"
                className="inline-flex h-12 w-full items-center justify-center rounded-2xl bg-black text-sm font-semibold text-white transition hover:bg-[#1f1f1f]"
              >
                Save Change
              </button>
            </div>
        ...
        <section className={surface}>
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              type="button"
              className="inline-flex h-11 items-center justify-center rounded-full border border-black/10 px-5 text-sm font-semibold text-black transition hover:bg-black hover:text-white"
            >
              Edit
            </button>
          </div>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            ...
            <label className="block space-y-2 md:col-span-2">
              ...
              <textarea
                defaultValue="Enter a biography about you"
                className="min-h-36 w-full rounded-2xl border border-black/10 bg-[#f5f5f5] px-4 py-3 text-sm outline-none"
              />
            </label>
          </div>
        </section>
