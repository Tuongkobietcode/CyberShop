...
import { getCurrentCustomer, loginCustomer, logoutCustomer, refreshCustomer, registerCustomer, forgotPassword, resetPassword } from "./customer-auth.controller.js";
...
customerAuthRouter.post("/reset-password", resetPassword);